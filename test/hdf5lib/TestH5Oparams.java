...
public class TestH5Oparams {
    ...
    public void testH5Oclose_invalid() throws Throwable, HDF5LibraryException {
        H5.H5Oclose(-1);
    }

    @Test(expected = NullPointerException.class)
    public void testH5Oopen_null() throws Throwable, HDF5LibraryException, NullPointerException {
        H5.H5Oopen(-1, null, 0);
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oopen_invalid() throws Throwable, HDF5LibraryException, NullPointerException {
        H5.H5Oopen(-1, "Bogus", 0);
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Ocopy_invalid() throws Throwable, HDF5LibraryException {
        H5.H5Ocopy(-1, "Bogus", -1, "Bogus", -1, -1);
    }

    @Test(expected = NullPointerException.class)
    public void testH5Ocopy_null_current() throws Throwable, HDF5LibraryException, NullPointerException {
...
//
//    @Test(expected = NullPointerException.class)
//    public void testH5Oget_info_by_idx_null() throws Throwable, HDF5LibraryException, NullPointerException {
