...
jint ctype;
    ...
    jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFNewCompInfo");
    if (jc == NULL) {
        return JNI_FALSE;
    }
    ...
    case COMP_CODE_SKPHUFF:
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFSKPHUFFCompInfo");
        if (jc == NULL) {
            return JNI_FALSE;
        }
    ...
    case COMP_CODE_DEFLATE:
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFDeflateCompInfo");
        if (jc == NULL) {
            return JNI_FALSE;
        }
        ...
        break;
    case COMP_CODE_SZIP:
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFSZIPCompInfo");
        if (jc == NULL) {
            return JNI_FALSE;
        }
...
*/
        ...
        break;
    case COMP_CODE_NBIT:
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFNBITCompInfo");
        if (jc == NULL) {
            return JNI_FALSE;
        }
...
jclass jc;
    ...
    jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFCompInfo");
...
jint ctype;
    ...
    jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFOldCompInfo");
    if (jc == NULL) {
        return JNI_FALSE;
    }
    jf = ENVPTR->GetFieldID(ENVPAR  jc, "ctype", "I");
    ...
    case COMP_JPEG:
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFJPEGCompInfo");
        if (jc == NULL) {
            return JNI_FALSE;
        }
...
jboolean bb;
    ...
    jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFChunkInfo");
    if (jc == NULL) {
        return JNI_FALSE;
    }
    jf = ENVPTR->GetFieldID(ENVPAR  jc, "ctype", "I");
    ...
    if (ctype == (HDF_CHUNK | HDF_COMP)) {
        ...
        jf = ENVPTR->GetFieldID(ENVPAR  jc, "cinfo", "Lhdf/h4/HDFCompInfo;");
        if (jf == NULL) {
            return JNI_FALSE;
        }
        larr = ENVPTR->GetObjectField(ENVPAR chunkobj,jf);
        ...
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFNBITChunkInfo");
        if (jc == NULL) {
            return JNI_FALSE;
        }
        jf = ENVPTR->GetFieldID(ENVPAR  jc, "chunk_lengths", "[I");
...
jobject compinfo;
    ...
    jci = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFChunkInfo");
    if (jci == NULL) {
        return JNI_FALSE;
    }
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_HCget_1config_1info
( JNIEnv *env,
jclass clss,
