...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFANaddfid
( JNIEnv *env,
jclass clss,
jint file_id,
jstring label)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFANclear
( JNIEnv *env,
jobject obj)
{
    intn rval;
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFANgetdesc
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANgetdesclen
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANgetfds
( JNIEnv *env,
jclass clss,
jint file_id,
jobjectArray desc_buf,  /* OUT: String */
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANgetfdslen
( JNIEnv *env,
jclass clss,
jint file_id,
jint isfirst)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANgetfid
( JNIEnv *env,
jclass clss,
jint file_id,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANgetfidlen
( JNIEnv *env,
jclass clss,
jint file_id,
jint isfirst)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFANgetlabel
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANgetlablen
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFANlablist
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFDeprecated_DFANlastref
( JNIEnv *env,
jobject obj)
{
    return (DFANlastref( ));
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFANputdesc
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFANputlabel
( JNIEnv *env,
jclass clss,
jstring filename,
jshort tag,
