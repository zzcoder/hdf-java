...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_VSQuerycount
( JNIEnv *env,
jclass clss,
jint vdata_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_VSQueryfields
( JNIEnv *env,
jclass clss,
jint vdata_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_VSQueryinterlace
( JNIEnv *env,
jclass clss,
jint vdata_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_VSQueryname
( JNIEnv *env,
jclass clss,
jint vdata_id,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_VSQueryref
( JNIEnv *env,
jclass clss,
jint vdata_id)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_VSQuerytag
( JNIEnv *env,
jclass clss,
jint vdata_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_VSQueryvsize
( JNIEnv *env,
jclass clss,
jint vdata_id,
