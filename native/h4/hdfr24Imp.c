...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_1DF24getdims
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_1DF24getimage
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFLibrary_DF24lastref
( JNIEnv *env,
jobject obj)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_1DF24readref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DF24restart
( JNIEnv *env,
jobject obj)
{
    int retVal;
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_1DF24nimages
( JNIEnv *env,
jclass clss,
jstring hdfFile)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DF24reqil
( JNIEnv *env,
jclass clss,
jint interlace)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_1DF24addimage
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_1DF24putimage
( JNIEnv *env,
jclass clss,
jstring filename,
jbyteArray image, /* IN: image data width X height X 3 */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DF24setcompress
( JNIEnv *env,
jclass clss,
jint type,
jobject cinfo)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DF24setdims
( JNIEnv *env,
jclass clss,
jint width,
jint height)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DF24setil
( JNIEnv *env,
jclass clss,
jint il)
{
