...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Hopen
(
JNIEnv *env,
jclass clss,
jstring hdfFile,
...

{
    ...
    if (file == NULL) {
        /* call failed? */
        jc = ENVPTR->FindClass(ENVPAR  "hdf/h4/HDFJavaException");
        if (jc == NULL) {
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hclose
( JNIEnv *env,
jclass clss,
jint fid)
{
...
/*
 * Class:     hdf_h4_HDFLibrary
 * Method:    HDdont_atexit
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_HDdont_1atexit
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hishdf
( JNIEnv *env,
jclass clss,
jstring hdfFile)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Hnumber
( JNIEnv *env,
jclass clss,
jint fid)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_DFKNTsize
( JNIEnv *env,
jclass clss,
jint numbertype)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hcache
( JNIEnv *env,
jclass clss,
jint file_id,
jint cache_switch)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hgetfileversion
( JNIEnv *env,
jclass clss,
jint file_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hgetlibversion
( JNIEnv *env,
jclass clss,
jintArray vers,  /* OUT: int major_v, minor_v, release */
jobjectArray string)  /* OUT: String[] */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hsetaccesstype
( JNIEnv *env,
jclass clss,
jint h_id,
jint  access_type)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Hsync
( JNIEnv *env,
jclass clss,
jint file_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_HDFclose
( JNIEnv *env,
jclass clss,
jint file_id)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_HDFopen
( JNIEnv *env,
jclass clss,
jstring filename,
jint access,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_HDFflusdd
( JNIEnv *env,
jclass clss,
jint file_id)
{
...
JNIEXPORT jstring JNICALL Java_hdf_h4_HDFLibrary_HDgetNTdesc
( JNIEnv *env,
jclass clss,
jint nt)
{
