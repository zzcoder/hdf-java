...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8getdims
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8getimage
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFLibrary_DFR8lastref
( JNIEnv *env,
jobject obj)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8readref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8restart
( JNIEnv *env,
jobject obj)
{
    int retVal;
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_DFR8nimages
( JNIEnv *env,
jclass clss,
jstring hdfFile)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8addimage
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8putimage
( JNIEnv *env,
jclass clss,
jstring filename,
jbyteArray image, /* IN: image data width X height X 3 */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8setcompress
( JNIEnv *env,
jclass clss,
jint type,
jobject cinfo)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8getpalref
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8setpalette
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFR8writeref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
