...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRstart
( JNIEnv *env,
jclass cls,
jint file_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRend
( JNIEnv *env,
jclass cls,
jint gr_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRendaccess
( JNIEnv *env,
jclass cls,
jint gr_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRfileinfo
( JNIEnv *env,
jclass cls,
jint gr_id,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRselect
( JNIEnv *env,
jclass cls,
jint gr_id,
jint index)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRnametoindex
( JNIEnv *env,
jclass cls,
jint gr_id,
jstring gr_name)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRgetchunkinfo
( JNIEnv *env,
jclass cls,
jint grsid,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRgetiminfo
( JNIEnv *env,
jclass cls,
jint ri_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRreadimage
( JNIEnv *env,
jclass cls,
jint ri_id,
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFLibrary_GRidtoref
( JNIEnv *env,
jclass cls,
jint gr_id)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRreftoindex
( JNIEnv *env,
jclass cls,
jint gr_id,
jshort ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRreqlutil
( JNIEnv *env,
jclass cls,
jint gr_id,
jint interlace_mode)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRreqimageil
( JNIEnv *env,
jclass cls,
jint gr_id,
jint interlace_mode)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRgetlutid
( JNIEnv *env,
jclass cls,
jint gr_id,
jint index)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRgetnluts
( JNIEnv *env,
jclass cls,
jint gr_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRgetlutinfo
( JNIEnv *env,
jclass cls,
jint ri_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRreadlut
( JNIEnv *env,
jclass cls,
jint pal_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRattrinfo
( JNIEnv *env,
jclass cls,
int gr_id,
jint attr_index,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRgetattr
( JNIEnv *env,
jclass cls,
jint gr_id,
jint attr_index,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRfindattr
( JNIEnv *env,
jclass cls,
jint gr_id,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRcreate
( JNIEnv *env,
jclass cls,
jint gr_id,
jstring name,
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFLibrary_GRluttoref
( JNIEnv *env,
jclass cls,
jint pal_id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRsetattr__ILjava_lang_String_2IILjava_lang_String_2
( JNIEnv *env,
jclass cls,
jint gr_id,
jstring attr_name,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRsetattr__ILjava_lang_String_2II_3B
( JNIEnv *env,
jclass cls,
jint gr_id,
jstring attr_name,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRsetcompress
( JNIEnv *env,
jclass cls,
jint ri_id,
jint comp_type,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRgetcompress
( JNIEnv *env,
jclass cls,
jint ri_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRsetchunk
( JNIEnv *env,
jclass cls,
jint sdsid,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_GRsetchunkcache
( JNIEnv *env,
jclass cls,
jint sdsid,
jint maxcache,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRsetexternalfile
( JNIEnv *env,
jclass cls,
jint ri_id,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRwriteimage
( JNIEnv *env,
jclass cls,
jint ri_id,
jintArray start,  /* IN: int[2] */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRwritelut
( JNIEnv *env,
jclass cls,
jint pal_id,
jint ncomp,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRreadchunk
( JNIEnv *env,
jclass cls,
jint grid,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_GRwritechunk
( JNIEnv *env,
jclass cls,
jint grid,
jintArray origin, /* IN: int[] */
