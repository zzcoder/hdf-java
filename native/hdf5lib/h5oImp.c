...
//
//        if (name == NULL) {
//            h5nullArgument(env, "H5Oget_info:  name is NULL");
//            return NULL;
//        }
//        
//        lName = (char*)ENVPTR->GetStringUTFChars(ENVPAR name, &isCopy);
//        if (lName == NULL) {
//            h5JNIFatalError(env, "H5Oget_info:  name not pinned");
//            return NULL;
//        }
//
//        status = H5Oget_info((hid_t)loc_id, (const char*)lName, (H5O_info_t*)&infobuf, (hid_t)access_id);
//
