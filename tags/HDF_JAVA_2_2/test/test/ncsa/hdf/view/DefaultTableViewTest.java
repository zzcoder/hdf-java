 ...
 * @author Peter X. Cao
 */
public class DefaultTableViewTest extends JInternalFrame
implements TableView
{
     ...
     */
    public DefaultTableViewTest(ViewManager theView) {
     ...
     * @param theView the main HDFView.
     */
    public DefaultTableViewTest(ViewManager theView, Boolean isDisplayChar, Boolean transposed)
    {
        super();
