...
%JAVAHOME%\bin\java -Djava.library.path="%LIBDIR%\win32" -Dncsa.hdf.h4toh5lib.h4toh5.h45lib="%LIBDIR%\win32\jh4toh5.dll" -Dncsa.hdf.hdflib.HDFLibrary.hdflib="%LIBDIR%\win32\jh4toh5.dll" -Dncsa.hdf.hdf5lib.h4toh5.hdf5lib="%LIBDIR%\win32\jh4toh5.dll" -classpath "%CLASSPATH%" linktest3
pause
:END 
