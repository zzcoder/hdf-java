@REM /****************************************************************************
@REM  * NCSA HDF                                                                 *
@REM  * National Comptational Science Alliance                                   *
@REM * University of Illinois at Urbana-Champaign                               *
@REM * 605 E. Springfield, Champaign IL 61820                                   *
@REM  *                                                                          *
@REM  * For conditions of distribution and use, see the accompanying             *
@REM  * hdf-java/COPYING file.                                                   *
@REM  *                                                                          *
@REM  ****************************************************************************/
@ECHO OFF
...
%JAVAHOME%\bin\java -Djava.library.path="%LIBDIR%\win32" -Dncsa.hdf.h4toh5lib.h4toh5.h45lib="%LIBDIR%\win32\jh4toh5.dll" -Dncsa.hdf.hdflib.HDFLibrary.hdflib="%LIBDIR%\win32\jh4toh5.dll" -Dncsa.hdf.hdf5lib.h4toh5.hdf5lib="%LIBDIR%\win32\jh4toh5.dll" -classpath "%CLASSPATH%" vgrouptest
pause
:END
