 ...
 */
public class DataOptionNPOESS extends JDialog implements ActionListener,
        ItemListener {
    ...
    public DataOptionNPOESS(ViewManager theview, Dataset theDataset) {
        ...
        if (dataset instanceof CompoundDS) {
            ...
            if (isText) {
                ...
                selectTableP.setBorder(BorderFactory
                ...
                selectImageP.setBorder(BorderFactory
                        .createLineBorder(Color.LIGHT_GRAY));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("Ok")) {
            ...
            String msg = "The bitmask is used to extract the value(s) of specific bit(s) from a byte data.\n"
