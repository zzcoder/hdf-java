...
public class TestH5E {
  ...
  public void testH5Ecreate_msg_major() {
    try { 
      int err_id = H5.H5Ecreate_msg(hdf_java_classid, HDF5Constants.H5E_MAJOR, "Error in Test"); 
  ...
  public void testH5Ecreate_msg_minor() {
    try { 
      int err_id = H5.H5Ecreate_msg(hdf_java_classid, HDF5Constants.H5E_MINOR, "Error in Test Function"); 
  ...
  public void testH5Eget_msg_major() {
    ...
    try { 
      ...
      try {
        ...
        String msg = H5.H5Eget_msg(hdferr.getMajorErrorNumber(), error_msg_type); 
        assertNotNull("H5.H5Eget_msg: "+msg,msg);
  ...
  public void testH5Eget_msg_minor() {
    ...
    try { 
      ...
      try {
        int[] error_msg_type = {HDF5Constants.H5E_MINOR};
        String msg = H5.H5Eget_msg(hdferr.getMinorErrorNumber(), error_msg_type); 
        assertNotNull("H5.H5Eget_msg: "+msg,msg);
