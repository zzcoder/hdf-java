...
public class TestH5Fparams {
  ...
  @Test(expected=NullPointerException.class)
  public void testH5Fis_hdf5_null() throws HDF5LibraryException, Throwable, NullPointerException {
    H5.H5Fis_hdf5(null); 
  }

  @Test(expected=NullPointerException.class)
  public void testH5Fmount_null() throws HDF5LibraryException, Throwable, NullPointerException {
    H5.H5Fmount(-1, null, -1, HDF5Constants.H5P_DEFAULT); 
  }

  @Test(expected=NullPointerException.class)
  public void testH5Funmount_null() throws HDF5LibraryException, Throwable, NullPointerException {
