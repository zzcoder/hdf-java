...
public class TestH5 {
    ...
    public void testJ2C() {
        ...
        int j2cValues[] = {
            ...
            HDF5Constants.H5F_ACC_DEBUG,
            HDF5Constants.H5F_ACC_CREAT,
            HDF5Constants.H5F_OBJ_FILE,
    ...
    /**
     * Test method for {@link ncsa.hdf.hdf5lib.H5#H5set_free_list_limits(int, int, int, int, int, int)}.
     */
    @Test
    ...
    /**
     * Test method for {@link ncsa.hdf.hdf5lib.H5#H5check_version(int, int, int)}.
     */
    @Test
