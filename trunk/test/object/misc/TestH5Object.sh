...
HDFVIEW_HOME=/home/abyrne/HDF_Projects/HDFJava-J-Trunk/bin
export HDFVIEW_HOME

# where Java is installed (requires jdk1.4.x)
JAVAPATH=/usr/lib/jvm/java-1.6.0-openjdk-1.6.0.0.x86_64/bin
export JAVAPATH
...
$JAVAPATH/javac TestH5Object".java"
(cd ../../..; $JAVAPATH/java -Xmx1024M -Djava.library.path=$HDFVIEW_HOME"/lib/"$OS_NAME test.object.misc.TestH5Object)
