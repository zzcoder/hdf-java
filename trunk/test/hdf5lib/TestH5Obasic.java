...
//
//    @Test(expected = HDF5LibraryException.class)
//    public void testH5Oget_info_not_exist() throws Throwable, HDF5LibraryException, NullPointerException {
//        H5.H5Oget_info(H5fid, "None", HDF5Constants.H5P_DEFAULT);
//    }
//
//    @Test
...
//        try {
//            link_info = H5.H5Oget_info(H5fid, "DS1", HDF5Constants.H5P_DEFAULT);
//        }
//        catch (Throwable err) {
//            err.printStackTrace();
...
//        assertTrue("H5Oget_info link type",link_info.type==HDF5Constants.H5O_TYPE_HARD);
...
//        H5O_info_t link_info = null;
//        try {
//            link_info = H5.H5Oget_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_NAME, HDF5Constants.H5_ITER_INC, 0, HDF5Constants.H5P_DEFAULT);
//        }
//        catch (Throwable err) {
//            err.printStackTrace();
...
//        H5O_info_t link_info = null;
//        try {
//            link_info = H5.H5Oget_info_by_idx(H5fid, "/", HDF5Constants.H5_INDEX_NAME, HDF5Constants.H5_ITER_INC, 3, HDF5Constants.H5P_DEFAULT);
//        }
//        catch (Throwable err) {
//            err.printStackTrace();
//            fail("H5.H5Oget_info_by_idx: " + err);
