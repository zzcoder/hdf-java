...
MACRO (EXTERNAL_HDF4_LIBRARY compress_type libtype jpeg_pic)
  ...
  IF (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      SET (HDF4_LIBRARY
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}hdf${DBG_EXT}${CMAKE_IMPORT_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}mfhdf${DBG_EXT}${CMAKE_IMPORT_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}xdr${DBG_EXT}${CMAKE_IMPORT_LIBRARY_SUFFIX}"
      )
      SET (EXTERNAL_LIBRARYDLL_LIST ${EXTERNAL_LIBRARYDLL_LIST} 
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}hdf${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}mfhdf${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}xdr${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
      )
    ELSE (WIN32 AND NOT MINGW)
      SET (HDF4_LIBRARY
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}hdf${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}mfhdf${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
      )
    ENDIF (WIN32 AND NOT MINGW)
  ELSE (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      SET (HDF4_LIBRARY
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/libhdf${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/libmfhd${DBG_EXT}f${CMAKE_STATIC_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/libxdr${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
      )
    ELSE (WIN32 AND NOT MINGW)
      SET (HDF4_LIBRARY
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libhdf${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
          "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libmfhdf${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
      )
    ENDIF (WIN32 AND NOT MINGW)
  ENDIF (${libtype} MATCHES "SHARED")
  SET (EXTERNAL_LIBRARY_LIST ${EXTERNAL_LIBRARY_LIST} ${HDF4_LIBRARY})
      ...
      FOREACH (HDF4_LIB ${HDF4_LIBRARY})
        ...
        IF (BUILD_TESTING)
          ADD_CUSTOM_TARGET (${HDF4_DLL_NAME}-Test-Copy ALL
              COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${HDF4_DLL_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${HDF4_DLL_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}
              COMMENT "Copying ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${HDF4_DLL_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX} to ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/"
          )
...
MACRO (EXTERNAL_HDF5_LIBRARY compress_type libtype)
  ...
  IF (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      SET (HDF5_LIBRARY "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}hdf5${DBG_EXT}${CMAKE_IMPORT_LIBRARY_SUFFIX}")
      SET (EXTERNAL_LIBRARYDLL_LIST ${EXTERNAL_LIBRARYDLL_LIST} "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/${CMAKE_IMPORT_LIBRARY_PREFIX}hdf5${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}")
    ELSE (WIN32 AND NOT MINGW)
      SET (HDF5_LIBRARY "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}hdf5${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}")
    ENDIF (WIN32 AND NOT MINGW)
  ELSE (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      SET (HDF5_LIBRARY "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/libhdf5${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}")
    ELSE (WIN32 AND NOT MINGW)
      SET (HDF5_LIBRARY "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libhdf5${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}")
    ENDIF (WIN32 AND NOT MINGW)
  ENDIF (${libtype} MATCHES "SHARED")
  SET (EXTERNAL_LIBRARY_LIST ${EXTERNAL_LIBRARY_LIST} ${HDF5_LIBRARY})
    ...
    IF (${libtype} MATCHES "SHARED")
      ...
      IF (BUILD_TESTING)
        ADD_CUSTOM_TARGET (HDF5_DLL_NAME-Test-Copy ALL
            COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${HDF5_DLL_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX} ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${HDF5_DLL_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}
            COMMENT "Copying ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}/${HDF5_DLL_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX} to ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/"
        )
