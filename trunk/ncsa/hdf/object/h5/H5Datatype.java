...
public class H5Datatype extends Datatype {
    ...
    /**
     * Constrcuts an named HDF5 data type object for a given file, dataset name
     * and group path.
     * <p>
     ...
     * 
     */
    public static final String[] convertEnumValueToName(int tid,
            Object inValues, String[] outNames) throws HDF5Exception {
        int inSize = 0;
    ...
    public int toNative() {
        ...
        try {
            ...
            case CLASS_REFERENCE:
                if (datatypeSize > H5
                        .H5Tget_size(HDF5Constants.H5T_STD_REF_OBJ)) {
    ...
    public static final String getDatatypeDescription(int tid) {
        ...
        if (tclass == HDF5Constants.H5T_INTEGER) {
            ...
            try {
                is_reg_ref = H5
                        .H5Tequal(tid, HDF5Constants.H5T_STD_REF_DSETREG);
            }
            catch (Exception ex) {
            }
            ...
            try {
                ...
                try {
                    H5.H5Tget_array_dims(tid, adims, null);
                }
                catch (Exception ex) {
                }
                description += " (" + adims[0];
            ...
            try {
                tmptid = H5.H5Tget_super(tid);
                description = "Variable-length of "
                        + getDatatypeDescription(tmptid);
            }
            catch (Exception ex) {
