...
public class H5 {
     ...
     */
    public final static int LIB_VERSION[] = { 1, 8, 6 };
    ...
    // following synchronized static native functions are missing from HDF5 RM
    // version 1.0.1
   ...
   */
    ...
    // * @exception HDF5LibraryException - Error from the HDF-5 Library.
    // **/
    // public synchronized static native int H5Pset_core(int plist, int
    // increment)
    // throws HDF5LibraryException;
    ...
    // **/
    // public synchronized static native int H5Pset_split(int plist, String
    // meta_ext,
    ...
    // * @exception HDF5LibraryException - Error from the HDF-5 Library.
    // **/
    // public synchronized static native int H5Pset_family(int plist, long
    // memb_size,
    // int memb_plist)
    // throws HDF5LibraryException;
    ...
    // **/
    // public synchronized static native int H5Pget_family(int tid, long[]
    // memb_size,
    // int[] memb_plist)
    // throws HDF5LibraryException, NullPointerException;
    ...
    // following synchronized static native functions are missing from HDF5
    // (version 1.0.1) RM
    ...
    public synchronized static int H5Gget_obj_info_all(int loc_id, String name,
        ...
        return H5Gget_obj_info_all(loc_id, name, oname, otype, ltype, ref, oname.length, indx_type );
    }
    private synchronized static native int H5Gget_obj_info_all(int loc_id,
            String name, String[] oname, int[] otype, int[] ltype, long[] ref, int n, int indx_type)
            throws HDF5LibraryException, NullPointerException;
