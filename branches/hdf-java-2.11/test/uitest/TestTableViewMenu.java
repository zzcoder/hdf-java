...
public class TestTableViewMenu {
    ...
    public void useCustomFormat() {
        ...
        try {
            ...
            JMenuItemFixture dataset1MenuItem = filetree.showPopupMenuAt(9).menuItemWithPath("Open");
            mainFrameFixture.robot.waitForIdle();
            ...
            mainFrameFixture.menuItemWithPath("Table", "Create custom notation").click();
            mainFrameFixture.robot.waitForIdle();
            ...
            mainFrameFixture.menuItemWithPath("Table", "Show Custom Notation").click();
            mainFrameFixture.robot.waitForIdle();
    ...
    @Ignore 
    public void selectCustomFormat() {
        File hdf_file = openHDF5File("tintsize", 10);
        File export_file = null;
        ...
        try {
            JTreeFixture filetree = mainFrameFixture.tree().focus();
            filetree.requireVisible();
            assertTrue("selectCustomFormat filetree shows:", filetree.target.getRowCount()==10);
            assertTrue("selectCustomFormat filetree has file", (filetree.valueAt(0)).compareTo("tintsize.h5")==0);
            assertTrue("selectCustomFormat filetree has group", (filetree.valueAt(1)).compareTo("DS08BITS")==0);
