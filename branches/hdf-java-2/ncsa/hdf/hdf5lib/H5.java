 ...
 * For that reason, the <a href="./ncsa.hdf.hdf5lib.HDFArray.html"><b>HDFArray</b></a> class is used
 * to discover the type, shape, and size of the data array at run time, and to convert to and from a
 ...
 * available to Java programs via the class <a href="./ncsa.hdf.hdf5lib.HDF5Constants.html">
 ...
 * To support these parameters, the Java class <a href="./ncsa.hdf.hdf5lib.HDF5CDataTypes.html">
 ...
 * href="./ncsa.hdf.hdf5lib.exceptions.HDF5Exception.html"> <b>HDF5Exception</b></a>. There are two
 * subclasses of <b>HDF5Exception</b>, <a
 * href="./ncsa.hdf.hdf5lib.exceptions.HDF5LibraryException.html"> <b>HDF5LibraryException</b></a>
 * and <a href="./ncsa.hdf.hdf5lib.exceptions.HDF5JavaException.html"> <b>HDF5JavaException</b></a>.
 * The sub-classes of the former represent errors from the HDF-5 C library, while sub-classes of the
 * latter represent errors in the JHI5 wrapper and support code.
 * <p>
 ...
 *          <a href ="./ncsa.hdf.hdf5lib.HDF5Exception.html"> ncsa.hdf.hdf5lib.HDF5Exception<BR>
...
public class H5 implements java.io.Serializable {
     ...
     */
    public final static int                     LIB_VERSION[]                = { 1, 8, 15 };
    ...
    private final static LinkedHashSet<Integer> OPEN_IDS                     = new LinkedHashSet<Integer>();
    ...
    /**
     * Get the open ID at the specified index. Always returns -1. To iterate over the set of open
     * IDs, use the getOpenIDs method and use an iterator.
     * 
     * @param index
     ...
     */
    public final static Collection<Integer> getOpenIDs ( )
    {
        return OPEN_IDS;
    }
     ...
     * application (the first time and after it's been unloaded).
     * <P>
     ...
     *                - Error from the HDF-5 Library.
     **/
    public synchronized static native void H5export_dataset (String file_export_name, String file_name, String object_path,
            int binary_order)
            throws HDF5LibraryException;
    ...
    public static int H5Aclose (int attr_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5A remove {}", attr_id);
    ...
    /**
     * H5Acreate creates an attribute, attr_name, which is attached to the object specified by the
     * identifier loc_id.
     * 
     * @param loc_id
    ...
    /**
     * H5Acreate2 an attribute, attr_name, which is attached to the object specified by the
     * identifier loc_id.
     * 
     * @see public static int H5Acreate( int loc_id, String attr_name, int type_id, int space_id,
     *      int acpl_id, int aapl_id )
     **/
    private synchronized static native int _H5Acreate2 (int loc_id, String attr_name, int type_id, int space_id, int acpl_id,
            int aapl_id)
            throws HDF5LibraryException, NullPointerException;

    /**
     * H5Acreate_by_name creates an attribute, attr_name, which is attached to the object specified
     * by loc_id and obj_name.
     * 
     * @param loc_id
     *            IN: Location or object identifier; may be dataset or group
     * @param obj_name
     ...
     *                - name is null.
     **/
    public static int H5Acreate_by_name (int loc_id, String obj_name, String attr_name, int type_id, int space_id, int acpl_id,
            int aapl_id, int lapl_id)
            throws HDF5LibraryException, NullPointerException
    {
    ...
    private synchronized static native int _H5Acreate_by_name (int loc_id, String obj_name, String attr_name, int type_id,
            int space_id,
     ...
     *                - obj_name is null.
     **/
    public synchronized static native void H5Adelete_by_idx (int loc_id, String obj_name, int idx_type, int order, long n,
            int lapl_id)
            throws HDF5LibraryException, NullPointerException;

    /**
     * H5Adelete_by_name removes the attribute attr_name from an object specified by location and
    ...
    /**
     * H5Aexists determines whether the attribute attr_name exists on the object specified by
     * obj_id.
     * 
     * @param obj_id
    ...
    /**
     * H5Aexists_by_name determines whether the attribute attr_name exists on an object. That object
     * is specified by its location and name, loc_id and obj_name, respectively.
     * 
     * @param loc_id
     ...
     *                - obj_name is null.
     **/
    public synchronized static native H5A_info_t H5Aget_info_by_idx (int loc_id, String obj_name, int idx_type, int order, long n,
            int lapl_id)
            throws HDF5LibraryException, NullPointerException;
     ...
     *                - obj_name is null.
     **/
    public synchronized static native String H5Aget_name_by_idx (int attr_id, String obj_name, int idx_type, int order, long n,
            int lapl_id)
            throws HDF5LibraryException, NullPointerException;
    ...
    /**
     * H5Aget_storage_size returns the amount of storage that is required for the specified
     * attribute, attr_id.
     * 
     * @param attr_id
    ...
    /**
     * H5Aopen opens an existing attribute, attr_name, that is attached to an object specified an
    ...
    /**
     * H5Aopen_by_idx opens an existing attribute that is attached to an object specified by
    ...
    private synchronized static native int _H5Aopen_by_idx (int loc_id, String obj_name, int idx_type, int order, long n,
            int aapl_id, int lapl_id)
            throws HDF5LibraryException, NullPointerException;
     ...
     *             {@link #H5Aopen_by_idx(int, String, int, int, long, int, int)  }
     * 
     * @param loc_id
     ...
     * 
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Aopen_by_name(int, String, String, int, int)}
     * 
     * @param loc_id
    ...
    /**
     * H5Arename_by_name changes the name of attribute that is attached to the object specified by
     * loc_id and obj_name. The attribute named old_attr_name is renamed new_attr_name.
     * 
     * @param loc_id
     *            IN: Location or object identifier; may be dataset or group
     * @param obj_name
     ...
     *                - Name is null.
     **/
    public synchronized static native int H5Arename_by_name (int loc_id, String obj_name, String old_attr_name,
            String new_attr_name, int lapl_id)
            throws HDF5LibraryException, NullPointerException;
     ...
     *                - Error from the HDF-5 Library.
     * @exception NullPointerException
     *                - data object is null. See public synchronized static native int H5Awrite(int
     *                attr_id, int mem_type_id, byte[] buf);
     **/
    ...
    public static int H5Dclose (int dataset_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5D remove {}", dataset_id);
     ...
     * 
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Dcreate(int, String, int, int, int, int, int) }
     * 
     * @param loc_id
     ...
     * 
     * @see public static int H5Dcreate(int loc_id, String name, int type_id, int space_id, int
     *      lcpl_id, int dcpl_id, int dapl_id)
     **/
    ...
    /**
     * H5Dfill explicitly fills the dataspace selection in memory, space_id, with the fill value
     * specified in fill.
     * 
     * @param fill
    ...
    /**
     * H5Dget_access_plist returns an identifier for a copy of the dataset access property list for
     * a dataset.
     * 
     * @param dset_id
     ...
     * 
     * @return returns the return value of the first operator that returns a positive value, or zero
     *         if all members were processed with no operator returning non-zero.
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     * @exception NullPointerException
    ...
    /**
     * H5Dopen opens the existing dataset specified by a location identifier and name, loc_id and
     * name, respectively.
     * 
    ...
    /**
     * H5Dopen2 opens the existing dataset specified by a location identifier and name, loc_id and
     * name, respectively.
     * 
    ...
    /**
     * H5Dset_extent sets the current dimensions of the chunked dataset dset_id to the sizes
     * specified in size.
     * 
     * @param dset_id
    ...
    /**
     * H5Dvlen_get_buf_size determines the number of bytes required to store the VL data from the
     * dataset, using the space_id for the selection in the dataset on disk and the type_id for the
     * memory representation of the VL data in memory.
     * 
     * @param dset_id
    ...
    /**
     * H5Eauto_is_v2 determines whether the error auto reporting function for an error stack
     * conforms to the H5E_auto2_t typedef or the H5E_auto1_t typedef.
     * 
     * @param stack_id
    ...
    /**
     * H5Eclear clears the error stack specified by estack_id, or, if estack_id is set to
     * H5E_DEFAULT, the error stack for the current thread.
     * 
     * @param stack_id
     *            IN: Error stack identifier.
     * 
    ...
    /**
     * H5Eclear2 clears the error stack specified by estack_id, or, if estack_id is set to
     * H5E_DEFAULT, the error stack for the current thread.
     * 
     * @see #H5Eclear
     **/
    ...
    /**
     * H5Eclose_msg closes an error message identifier, which can be either a major or minor
     * message.
     * 
     * @param err_id
    ...
    /**
     * H5Ecreate_msg adds an error message to an error class defined by client library or
     * application program.
     * 
     * @param cls_id
    ...
    /**
     * H5Eget_current_stack copies the current error stack and returns an error stack identifier for
     * the new copy.
     * 
     * @return an error stack identifier
     * 
    ...
    /**
     * H5Eset_current_stack replaces the content of the current error stack with a copy of the
     * content of the error stack specified by estack_id.
     * 
     * @param stack_id
     *            IN: Error stack identifier.
     * 
    ...
    /**
     * H5Eget_num retrieves the number of error records in the error stack specified by estack_id
     ...
     * 
     * @param stack_id
     *            IN: Error stack identifier.If the identifier is H5E_DEFAULT, the current error
    ...
    /**
     * H5Epop deletes the number of error records specified in count from the top of the error stack
    ...
    /**
     * H5Eregister_class registers a client library or application program to the HDF5 error API so
     * that the client library or application program can report errors together with HDF5 library.
     * 
     * @param cls_name
     *            IN: Name of the error class.
     * @param lib_name
    ...
    // }
    // public synchronized static native int H5Epush2(int err_stack, String file, String func, int
    // line,
    // int cls_id, int maj_id, int min_id, String msg, ...);
    ...
    // }
    // int H5Ewalk2(int err_stack, H5E_direction_t direction, H5E_walk2_t func, Pointer
    // client_data);
    ...
    public static int H5Fclose (int file_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5F remove {}", file_id);
     ...
     *            <LI>
     *            H5F_ACC_TRUNC Truncate file, if it already exists, erasing all data previously
     ...
     * 
     * @param create_id
     *            File creation property list identifier, used when modifying default file
     *            meta-data. Use H5P_DEFAULT for default access properties.
     * @param access_id
     *            File access property list identifier. If parallel file access is desired, this is
     *            a collective call according to the communicator stored in the access_id (not
     *            supported in Java). Use H5P_DEFAULT for default access properties.
     * 
     * @return a file identifier if successful
     * 
     * @exception HDF5LibraryException
     ...
     *            associated with the file, including the file itself, a dataset, a group, an
     *            attribute, or a named data type.
     * @param scope
     *            specifies the scope of the flushing action, in the case that the HDF-5 file is not
    ...
    /**
     * H5Fget_intent retrieves the intended access mode flag passed with H5Fopen when the file was
     * opened.
     * 
     * @param file_id
     *            IN: File identifier for a currently-open HDF5 file
    ...
    /**
     * H5Fget_mdc_hit_rate queries the metadata cache of the target file to obtain its hit rate
     * (cache hits / (cache hits + cache misses)) since the last time hit rate statistics were
     * reset.
     * 
     * @param file_id
    ...
    /**
     * H5Fget_mdc_size queries the metadata cache of the target file for the desired size
     * information.
     * 
     * @param file_id
     *            IN: Identifier of the target file.
     ...
     *            <li>H5F_OBJ_LOCAL Restrict search to objects opened through current file
     *            identifier.</li>
     *            </ul>
     * 
    ...
    /**
     * H5Fget_obj_ids returns the list of identifiers for all open HDF5 objects fitting the
     * specified criteria.
     * 
     * @param file_id
     *            IN: File identifier for a currently-open HDF5 file
     ...
     * 
     * @param loc_id
     *            The identifier for the group onto which the file specified by child_id is to be
     *            mounted.
     * @param name
    ...
    public static int H5Gclose (int group_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5G remove {}", group_id);
     ...
     * @param size_hint
     *            An optional parameter indicating the number of bytes to reserve for the names that
     ...
     * @param gapl_id
     *            IN: Identifier of group access property list. (No group access properties have
     *            been implemented at this time; use H5P_DEFAULT.)
     * 
     ...
     * 
     * @param loc_id
     *            IN: File or group identifier specifying the file in which the new group is to be
     *            created.
     * @param gcpl_id
     *            IN: Identifier of group creation property list.
     * @param gapl_id
    ...
    /**
     * H5Gget_create_plist returns an identifier for the group creation property list associated
     * with the group specified by group_id.
     * 
     * @param group_id
    ...
    /**
     * H5Gget_info retrieves information about the group specified by group_id. The information is
     * returned in the group_info struct.
     * 
     * @param group_id
     *            IN: Identifier of the group.
     * 
    ...
    /**
     * H5Gget_info_by_idx retrieves information about a group, according to the group's position
     * within an index.
     * 
     * @param group_id
    ...
    /**
     * H5Gget_info_by_name retrieves information about the group group_name located in the file or
     * group specified by loc_id.
     * 
     * @param group_id
     *            IN: File or group identifier.
     * @param name
    ...
    /**
     * retrieves information of all objects under the group (name) located in the file or group
     * specified by loc_id.
     * 
     * @param loc_id
     *            IN: File or group identifier
    ...
    /*
     * ////////////////////////////////////////////////////////////////////////// /////// // //
     * //Add these methods so that we don't need to call //in a loop to get information for all the
     * object in a group, which takes //a lot of time to finish if the number of objects is more
     * than 10,000 // ///////////////////////////////////////////
     * //////////////////////////////////////
     */
    /**
     * retrieves information of all objects (recurvisely) under the group (name) located in the file
     * or group specified by loc_id upto maximum specified by objMax.
     * 
     * @param loc_id
     *            IN: File or group identifier
     * @param objNames
     ...
     *                - bad argument.
     * 
     * @deprecated As of HDF5 1.8, replaced by {@link #H5Lget_info(int, String, int) and
     *             #H5Oget_info(int)}
     **/
    @Deprecated
     ...
     *                - name is null.
     * 
     * @see ncsa.hdf.hdf5lib.HDF5GroupInfo See public synchronized static native int
     *      H5Gget_objinfo();
     * 
     ...
     * 
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Lget_name_by_idx(int, String, int, int, long, int)}
     */
    @Deprecated
     ...
     *            </UL>
     * @param current_name
     *            A name of the existing object if link is a hard link. Can be anything for the soft
     *            link.
     * @param new_name
     ...
     * 
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Lcreate_hard(int, String, int, String, int, int) and
    ...
    /**
     * H5Iget_type_ref retrieves the reference count on an ID type. The reference count is used by
     * the library to indicate when an ID type can be destroyed.
     * 
     * @param type
    ...
    /**
     * H5Lcreate_external creates a new soft link to an external object, which is an object in a
     * different HDF5 file from the location of the link.
     * 
     * @param file_name
    ...
    /**
     * H5Ldelete_by_idx removes the nth link in a group according to the specified order and in the
     * specified index.
     * 
     * @param loc_id
    ...
    /**
     * H5Lget_info_by_idx opens a named datatype at the location specified by loc_id and return an
    ...
    /**
     * H5Lget_name_by_idx retrieves name of the nth link in a group, according to the order within a
     * specified field or index.
     * 
     * @param loc_id
     *            IN: File or group identifier specifying location of subject group
     * @param group_name
    ...
    /**
     * H5Lget_val_by_idx retrieves value of the nth link in a group, according to the order within
     * an index.
     * 
     * @param loc_id
     *            IN: File or group identifier specifying location of subject group
     ...
     * @param op_data
     *            IN: User-defined pointer to data required by the application for its processing of
     *            the link
     * 
     * @return returns the return value of the first operator that returns a positive value, or zero
     *         if all members were processed with no operator returning non-zero.
    ...
    public static int H5Oclose (int object_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5O remove {}", object_id);
    ...
    /**
     * H5Ocopy copies the group, dataset or named datatype specified from the file or group
     * specified by source location to the destination location.
     * 
     * @param src_loc_id
    ...
    // long H5Oget_comment_by_name(int loc_id, String name, String comment, long bufsize, int
    // lapl_id);
    ...
    /**
     * H5Oget_info_by_idx retrieves the metadata for an object, identifying the object by an index
     * position.
     * 
     * @param loc_id
     *            IN: File or group identifier
     ...
     *            IN: Object to open
     * @param lapl_id
     *            IN: Access property list identifier for the link pointing to the object (Not
     *            currently used; pass as H5P_DEFAULT.)
     * 
     * @return object information
     * 
     * @exception HDF5LibraryException
    ...
    /**
     * H5Oget_info_by_name retrieves the metadata for an object, identifying the object by location
     * and relative name.
     * 
     * @param loc_id
     *            IN: File or group identifier specifying location of group in which object is
     *            located
     * @param name
    ...
    // /**
    // * H5Oopen_by_addr opens a group, dataset, or named datatype using its address within an HDF5
    // file.
    // *
    ...
    public static int H5Pclose (int plist) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5P remove {}", plist);
     ...
     * 
     * Given a dataset transfer property list, H5Pset_buffer sets the maximum size for the type
     * conversion buffer and background buffer and optionally supplies pointers to
     * application-allocated buffers. If the buffer size is smaller than the entire amount of data
     * being transferred between the application and the file, and a type conversion buffer or
     * background buffer is required, then strip mining will be used.
     * 
     * Note that there are minimum size requirements for the buffer. Strip mining can only break the
     * data up along the first dimension, so the buffer must be large enough to accommodate a
     * complete slice that encompasses all of the remaining dimensions. For example, when strip
     * mining a 100x200x300 hyperslab of a simple data space, the buffer must be large enough to
     * hold 1x200x300 data elements. When strip mining a 100x200x300x150 hyperslab of a simple data
     * space, the buffer must be large enough to hold 1x200x300x150 data elements.
     * 
     * @param plist
     *            Identifier for the dataset transfer property list.
     * @param size
    ...
    /**
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Pget_cache(int, int[], long[], long[], double[]) } because of possible
     *             loss of precision
     **/
    @Deprecated
    ...
    /**
     * Retrieves the maximum possible number of elements in the meta data cache and the maximum
     * possible number of bytes and the RDCC_W0 value in the raw data chunk cache on a per-datset
     * basis.
     * 
     * @param dapl_id
    ...
    /**
     * H5Pset_chunk_cache sets the number of elements (objects) in the meta data cache and the total
     * number of bytes in the raw data chunk cache on a per-datset basis.
     * 
     * @param dapl_id
    ...
    /**
     * H5Pset_create_intermediate_group specifies in property list whether to create missing
     * intermediate groups
     * 
     * @param lcpl_id
     *            IN: Link creation property list identifier
     * @param crt_intermed_group
     *            IN: Flag specifying whether to create intermediate groups upon the creation of an
     *            object
     * 
    ...
    /**
     * H5Pget_data_transform retrieves the data transform expression previously set in the dataset
     * transfer property list plist_id by H5Pset_data_transform.
     * 
     * @param plist_id
     ...
     * 
     * @return The size of the transform expression if successful; 0(zero) if no transform
     *         expression exists. Otherwise returns a negative value.
     * 
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
    ...
    /**
     * H5Pget_driver returns the identifier of the low-level file driver associated with the file
     * access property list or data transfer property list plid.
     * 
     * @param plid
    ...
    /**
     * H5Pget_elink_acc_flags retrieves the external link traversal file access flag from the
    ...
    /**
     * H5Pset_elink_acc_flags Sets the external link traversal file access flag in a link access
     * property list.
     * 
     * @param lapl_id
     *            IN: Link access property list identifier
    ...
    /**
     * H5Pget_elink_fapl Retrieves the file access property list identifier associated with the link
    ...
    /**
     * H5Pset_elink_fapl sets a file access property list for use in accessing a file pointed to by
     * an external link.
     * 
     * @param lapl_id
     *            IN: Link access property list identifier
    ...
    /**
     * H5Pset_elink_file_cache_size sets the number of files that can be held open in an external
     ...
     * 
     * @return If successful, returns a non-negative value specifying the size in bytes of the
     *         prefix without the NULL terminator; otherwise returns a negative value.
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     * @exception NullPointerException
    ...
    /**
     * H5Pget_est_link_info Queries data required to estimate required local heap or object header
     * size.
     * 
     * @param gcpl_id
     *            IN: Group creation property list identifier
     * @param link_info
     *            Estimated number of links to be inserted into group And the estimated average
     *            length of link names
     * 
     *            <pre>
     ...
     * @param offset
     *            IN: Offset, in bytes, from the beginning of the file to the location in the file
     ...
     *            IN: File access property list identifier
     * @param info
     *            OUT: Returned property list information info[0] = alignment Required memory
     *            alignment boundary info[1] = block_size File system block size info[2] = cbuf_size
     *            Copy buffer size
     * 
     * @return a non-negative value if successful; otherwise returns a negative value.
     * 
     ...
     * @param memb_addr
     *            IN: The offsets within the virtual address space, from 0 (zero) to HADDR_MAX, at
     *            which each type of data storage begins.
     * 
     ...
     * 
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Pget_filter(int, int, int[], long[], int[], long, String[], int[]) }
     * 
     * @param plist
     *            IN: Property list identifier.
     * @param filter_number
     *            IN: Sequence number within the filter pipeline of the filter for which information
     *            is sought.
     * @param flags
    ...
    /**
     * H5Pget_filter2 returns information about a filter, specified by its filter number, in a
     * filter pipeline, specified by the property list with which it is associated.
     * 
     * @see public static int H5Pget_filter(int plist, int filter_number, int[] flags, int[]
     *      cd_nelmts, int[] cd_values, int namelen, String[] name, int[] filter_config)
     * 
     **/
    ...
    /**
     * H5Pget_filter_by_id returns information about the filter specified in filter_id, a filter
     * identifier. plist_id must be a dataset or group creation property list and filter_id must be
     * in the associated filter pipeline. The filter_id and flags parameters are used in the same
     * manner as described in the discussion of H5Pset_filter. Aside from the fact that they are
     * used for output, the parameters cd_nelmts and cd_values[] are used in the same manner as
     * described in the discussion of H5Pset_filter. On input, the cd_nelmts parameter indicates the
     * number of entries in the cd_values[] array allocated by the calling program; on exit it
     * contains the number of values defined by the filter. On input, the namelen parameter
     * indicates the number of characters allocated for the filter name by the calling program in
     * the array name[]. On exit name[] contains the name of the filter with one character of the
     * name in each element of the array. If the filter specified in filter_id is not set for the
     * property list, an error will be returned and H5Pget_filter_by_id1 will fail.
     * 
     * @deprecated As of HDF5 1.8, replaced by
     *             {@link #H5Pget_filter_by_id(int, int, int[], long[], int[], long, String[], int[]) }
     * 
     * @param plist_id
     *            IN: Property list identifier.
     * @param filter_id
    ...
    /**
     * H5Pget_filter_by_id2 returns information about a filter, specified by its filter id, in a
     * filter pipeline, specified by the property list with which it is associated.
     * 
    ...
    /**
     * H5Pget_libver_bounds retrieves the lower and upper bounds on the HDF5 Library versions that
     * indirectly determine the object formats versions used when creating objects in the file.
     * 
     * @param fapl_id
     *            IN: File access property list identifier
     * @param libver
    ...
    /**
     * H5Pset_libver_bounds Sets bounds on library versions, and indirectly format versions, to be
    ...
    /**
     * H5Pget_link_creation_order queries the group creation property list, gcpl_id, and returns a
     * flag indicating whether link creation order is tracked and/or indexed in a group.
     * 
     * @param gcpl_id
     *            IN: Group creation property list identifier
     * 
    ...
    /**
     * H5Pset_link_creation_order Sets flags in a group creation property list, gcpl_id, for
    ...
    /**
     * H5Pget_link_phase_change Queries the settings for conversion between compact and dense
     * groups.
     * 
     * @param gcpl_id
     *            IN: Group creation property list identifier
     * @param links
     *            The max. no. of compact links & the min. no. of dense links, which are used for
     *            storing groups
     * 
     *            <pre>
    ...
    /**
     * H5Pget_local_heap_size_hint Retrieves the anticipated size of the local heap for
    ...
    /**
     * H5Pget_mdc_config gets the initial metadata cache configuration contained in a file access
     * property list and loads it into the instance of H5AC_cache_config_t pointed to by the
     * config_ptr parameter. This configuration is used when the file is opened.
     * 
     * @param plist_id
     *            IN: Identifier of the file access property list.
     * 
     * @return A buffer(H5AC_cache_config_t) for the current metadata cache configuration
     *         information
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
    ...
    /**
     * H5Pget_nlinks retrieves the maximum number of soft or user-defined link traversals allowed,
     * nlinks, before the library assumes it has found a cycle and aborts the traversal. This value
     * is retrieved from the link access property list lapl_id.
     * 
     * @param lapl_id
     *            IN: File access property list identifier
     * 
    ...
    /**
     * H5Pset_nlinks sets the maximum number of soft or user-defined link traversals allowed,
     * nlinks, before the library assumes it has found a cycle and aborts the traversal. This value
     * is set in the link access property list lapl_id.
     * 
     * @param lapl_id
     *            IN: File access property list identifier
     * @param nlinks
     ...
     * 
     * @deprecated As of HDF5 1.8, compound datatype field preservation is now core functionality in
     *             the HDF5 Library.
     * 
     * @param plist
    ...
    /**
     * H5Pget_obj_track_times queries the object creation property list, ocpl_id, to determine
    ...
    /**
     * H5Pset_obj_track_times sets a property in the object creation property list, ocpl_id, that
     * governs the recording of times associated with an object.
     * 
     * @param ocpl_id
     *            IN: Object creation property list identifier
     * 
     ...
     * 
     **/
    public synchronized static native int H5Pset_shared_mesg_index (int fcpl_id, int index_num, int mesg_type_flags,
            int min_mesg_size)
            throws HDF5LibraryException, IllegalArgumentException;

    /**
     * H5Pget_shared_mesg_nindexes retrieves number of shared object header message indexes in file
     * creation property list.
     * 
     * @param fcpl_id
     *            IN: : File creation property list identifier
     * 
     * @return nindexes, the number of shared object header message indexes available in files
     *         created with this property list
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     * 
    ...
    /**
     * H5Pset_shared_mesg_nindexes sets the number of shared object header message indexes in the
     * specified file creation property list.
     * 
     * @param plist_id
     *            IN: File creation property list
     * @param nindexes
     *            IN: Number of shared object header message indexes to be available in files
     *            created with this property list
     * 
     * @return a non-negative value if successful; otherwise returns a negative value.
     * 
    ...
    /**
     * H5Pget_shared_mesg_phase_change retrieves shared object header message phase change
     * information.
     * 
     * @param fcpl_id
     *            IN: : File creation property list identifier
     * @param size
     *            The threshold values for storage of shared object header message indexes in a
     *            file.
     * 
     *            <pre>
    ...
    /**
     * H5Pset_shared_mesg_phase_change sets shared object header message storage phase change
     * thresholds.
     * 
     * @param fcpl_id
     *            IN: File creation property list identifier
     * @param max_list
     *            IN: Threshold above which storage of a shared object header message index shifts
     *            from list to B-tree
     * @param min_btree
     *            IN: Threshold below which storage of a shared object header message index reverts
     *            to list format
     * 
     * @return a non-negative value if successful; otherwise returns a negative value.
     * 
    ...
    /**
     * H5Pset_fapl_log Sets up the logging virtual file driver (H5FD_LOG) for use. H5Pset_fapl_log
     * modifies the file access property list to use the logging driver, H5FD_LOG. The logging
     * virtual file driver (VFD) is a clone of the standard SEC2 (H5FD_SEC2) driver with additional
     ...
     *            IN: File access property list identifier.
     * @param logfile
     *            IN: logfile is the name of the file in which the logging entries are to be
     *            recorded.
     * @param flags
    ...
    // hid_t H5Pcreate_class( hid_t parent_class, const char *name, H5P_cls_create_func_t create,
    ...
    // herr_t H5Pget_vlen_mem_manager(hid_t plist, H5MM_allocate_t *alloc, void **alloc_info,
    // H5MM_free_t *free, void **free_info )
    // herr_t H5Pset_vlen_mem_manager(hid_t plist, H5MM_allocate_t alloc, void *alloc_info,
    // H5MM_free_t free, void *free_info )
     ...
     * 
     * @param loc_id
     *            IN: Identifier for the dataset containing the reference or for the group that
     *            dataset is in.
     * @param ref_type
     *            IN: Type of reference.
     * @param ref
     ...
     * 
     * @return Returns the length of the name if successful, returning 0 (zero) if no name is
     *         associated with the identifier. Otherwise returns a negative value.
     * 
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
    ...
    /*
     * [NOTE: This function is only supported in HDF5 Releases 1.4.x. It has been replaced in
     * Release 1.6 by the function H5Rget_obj_type public synchronized static native int
     * H5Rget_object_type(int loc_id, byte ref[]) throws HDF5LibraryException, NullPointerException,
     * IllegalArgumentException;
     */
    /**
    ...
    /**
     * H5Rget_obj_type Given a reference to an object ref, H5Rget_obj_type returns the type of the
     * object pointed to.
     * 
     * @param loc_id
     *            IN: loc_id of the reference object.
     ...
     * 
     * @return Returns the object type, which is the same as obj_type[0]. The return value is the
     *         same as the HDF5 1.6 version.
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     * @exception NullPointerException
    ...
    public static int H5Sclose (int space_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5S remove {}", space_id);
    ...
    /**
     * H5Sextent_equal determines whether the dataspace extents of two dataspaces, space1_id and
     * space2_id, are equal.
     * 
     ...
     * @param buf
     *            returns blocks startblock to startblock+num-1, each block is <i>rank</i> * 2
     *            (corners) longs.
     * 
     * @return a non-negative value if successful
     * 
    ...
    /**
     * H5Sget_select_type retrieves the type of selection currently defined for the dataspace
     * space_id.
     * 
     * @param space_id
     *            IN: Identifier of the dataspace object to query
    ...
    public static int H5Tclose (int type_id) throws HDF5LibraryException
    {
        ...
        log.trace("OPEN_IDS: H5T remove {}", type_id);
    ...
    /**
     * H5Tcommit_anon commits a transient datatype (not immutable) to a file, turning it into a
     * named datatype with the specified creation and property lists.
     * 
     * @param loc_id
     *            IN: Location identifier.
     * @param type_id
    ...
    /**
     * H5Tcompiler_conv finds out whether the library's conversion function from type src_id to type
     * dst_id is a compiler (hard) conversion.
     * 
     * @param src_id
    ...
    // int H5Tconvert(int src_id, int dst_id, long nelmts, Pointer buf, Pointer background, int
    // plist_id);
     ...
     * 
     * @param type_id
     *            IN: Identifier of datatype to copy. Can be a datatype identifier, a predefined
    ...
    /**
     * H5Tdetect_class determines whether the datatype specified in dtype_id contains any datatypes
     * of the datatype class specified in dtype_class.
     * 
     * @param type_id
     ...
     * 
     * @return true if the datatype specified in dtype_id contains any datatypes of the datatype
     *         class
     * 
     * @exception HDF5LibraryException
     *                - Error from the HDF-5 Library.
     ...
     *            IN: Identifier of the object to be encoded.
     * @param buf
     *            OUT: Buffer for the object to be encoded into. If the provided buffer is NULL,
     *            only the size of buffer needed is returned.
     * @param nalloc
    ...
    /**
     * H5Tget_array_dims1 returns the sizes of the dimensions of the specified array datatype
     * object.
     * 
    ...
    /**
     * H5Tget_array_dims2 returns the sizes of the dimensions of the specified array datatype
     * object.
     * 
    ...
    /**
     * H5Tget_create_plist returns a property list identifier for the datatype creation property
     * list associated with the datatype specified by type_id.
     * 
     * @param type_id
     *            IN: Identifier of datatype.
     * 
    ...
    /**
     * H5Tget_native_type returns the equivalent native datatype for the datatype specified in
     * type_id.
     * 
     * @param type_id
     *            IN: Identifier of datatype to query. Direction of search is assumed to be in
     *            ascending order.
     * 
    ...
    /**
     * H5Tis_variable_str determines whether the datatype identified in type_id is a variable-length
     * string.
     * 
     * @param type_id
     *            IN: Identifier of datatype to query.
    ...
    // public synchronized static native int H5Tregister(H5T_pers_t pers, String name, int src_id,
    // int dst_id,
    // H5T_conv_t func)
    // throws HDF5LibraryException, NullPointerException;

    // public synchronized static native int H5Tunregister(H5T_pers_t pers, String name, int src_id,
    // int dst_id,
    // H5T_conv_t func)
    // throws HDF5LibraryException, NullPointerException;
