...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFPaddpal
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFPgetpal
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFLibrary_DFPlastref
( JNIEnv *env,
jobject obj)
{
    return (DFPlastref( ));
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_DFPnpals
( JNIEnv *env,
jclass clss,
jstring filename)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFPputpal
( JNIEnv *env,
jclass clss,
jstring filename,
jbyteArray palette, /* IN:  byte[] */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFPreadref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
...
JNIEXPORT jshort JNICALL Java_hdf_h4_HDFLibrary_DFPrestart
( JNIEnv *env,
jobject obj)
{
    return (DFPrestart( ));
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_DFPwriteref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
