...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vstart
(JNIEnv *env,
jclass clss,
jint fid)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vattach
(JNIEnv *env,
jclass clss,
jint fid,
jint vgroup_ref,
...
JNIEXPORT void JNICALL Java_hdf_h4_HDFLibrary_Vdetach
(JNIEnv *env,
jclass clss,
jint vgroup_id)
{
...
JNIEXPORT void JNICALL Java_hdf_h4_HDFLibrary_Vend
(JNIEnv *env,
jclass clss,
jint fid)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vgetid
(JNIEnv *env,
jclass clss,
jint fid,
jint vgroup_ref)
...
JNIEXPORT void JNICALL Java_hdf_h4_HDFLibrary_Vgetclass
(JNIEnv *env,
jclass clss,
jint vgroup_id,
...
JNIEXPORT void JNICALL Java_hdf_h4_HDFLibrary_Vgetname
(JNIEnv *env,
jclass clss,
jint vgroup_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Visvg
(JNIEnv *env,
jclass clss,
jint vgroup_id,
jint vgroup_ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Visvs
(JNIEnv *env,
jclass clss,
jint vgroup_id,
jint vdata_ref)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vgettagrefs
(JNIEnv *env,
jclass clss,
jint vgroup_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vgettagref
(JNIEnv *env,
jclass clss,
jint vgroup_id,
jint index,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vntagrefs
(JNIEnv *env,
jclass clss,
jint vgroup_id)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vinqtagref
(JNIEnv *env,
jclass clss,
jint vgroup_id,
jint tag,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vlone
(JNIEnv *env,
jclass clss,
jint fid,
jintArray ref_array,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vaddtagref
( JNIEnv *env,
jclass clss,
jint vgroup_id,
jint tag,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vdeletetagref
( JNIEnv *env,
jclass clss,
jint vgroup_id,
jint tag,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vclose_I
( JNIEnv *env,
jclass clss,
jint file_id)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vfind
( JNIEnv *env,
jclass clss,
jint file_id,
jstring vgname)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vfindclass
( JNIEnv *env,
jclass clss,
jint file_id,
jstring vgclassname)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vflocate
( JNIEnv *env,
jclass clss,
jint key,
jstring field)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vgetnext
( JNIEnv *env,
jclass clss,
jint vkey,
jint elem_ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vinquire
( JNIEnv *env,
jclass clss,
jint vgroup_id,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vinsert
( JNIEnv *env,
jclass clss,
jint vgroup_id,
jint v_id)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vnrefs
( JNIEnv *env,
jclass clss,
jint vkey,
jint tag)
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vopen
( JNIEnv *env,
jclass clss,
jstring filename,
jint access,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vsetclass
(JNIEnv *env,
jclass clss,
jint vgroup_id,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vsetname
(JNIEnv *env,
jclass clss,
jint vgroup_id,
jstring name)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vattrinfo
( JNIEnv *env,
jclass clss,
jint id,
jint index,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vfindattr
( JNIEnv *env,
jclass clss,
jint id,
jstring name)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vgetattr
( JNIEnv *env,
jclass clss,
jint gr_id,
jint attr_index,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vgetversion
( JNIEnv *env,
jclass clss,
jint id)
{
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFLibrary_Vnattrs
( JNIEnv *env,
jclass clss,
jint id)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vsetattr__ILjava_lang_String_2IILjava_lang_String_2
( JNIEnv *env,
jclass clss,
jint gr_id,
jstring attr_name,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFLibrary_Vsetattr__ILjava_lang_String_2II_3B
( JNIEnv *env,
jclass clss,
jint id,
jstring attr_name,
