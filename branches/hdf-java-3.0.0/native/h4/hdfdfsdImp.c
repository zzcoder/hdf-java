...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDadddata
( JNIEnv *env,
jclass clss,
jstring filename,
jint rank,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDclear
( JNIEnv *env,
jobject obj)
{
    if (DFSDclear( ) == FAIL) {
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDendslab
( JNIEnv *env,
jobject obj)
{
    if (DFSDendslab( ) == FAIL) {
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDendslice
( JNIEnv *env,
jobject obj)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetcal
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdata
( JNIEnv *env,
jclass clss,
jstring filename,
jint rank,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdatalen
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdatastrs
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdimlen
( JNIEnv *env,
jclass clss,
jint dim,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdims
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdimscale
( JNIEnv *env,
jclass clss,
jint dim,
jint size,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetdimstrs
( JNIEnv *env,
jclass clss,
jint dim,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetfillvalue
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetNT
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetrange
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDgetslice
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFSDlastref
( JNIEnv *env,
jobject obj)
{
    return DFSDlastref( );
...
JNIEXPORT jint JNICALL Java_hdf_h4_HDFDeprecated_DFSDndatasets
( JNIEnv *env,
jclass clss,
jstring filename)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDpre32sdg
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDputdata
( JNIEnv *env,
jclass clss,
jstring filename,
jint rank,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDputslice
( JNIEnv *env,
jclass clss,
jintArray windims,  /* IN: int[] */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDreadref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDreadslab
( JNIEnv *env,
jclass clss,
jstring filename,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDrestart
( JNIEnv *env,
jobject obj)
{
    if (DFSDrestart( ) == FAIL) {
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetcal
( JNIEnv *env,
jclass clss,
jdouble cal,
jdouble cal_err,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetdatastrs
( JNIEnv *env,
jclass clss,
jstring label,
jstring unit,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetdims
( JNIEnv *env,
jclass clss,
jint rank,
jintArray dimsizes)  /* IN:  int[] */
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetdimscale
( JNIEnv *env,
jclass clss,
jint dim,
jint dimsize,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetdimstrs
( JNIEnv *env,
jclass clss,
jint dim,
jstring label,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetfillvalue
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetlengths
( JNIEnv *env,
jclass clss,
jint label_len,
jint unit_len,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetNT
( JNIEnv *env,
jclass clss,
jint data_type)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDsetrange
( JNIEnv *env,
jclass clss,
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDstartslab
( JNIEnv *env,
jclass clss,
jstring filename)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDstartslice
( JNIEnv *env,
jclass clss,
jstring filename)
{
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDwriteref
( JNIEnv *env,
jclass clss,
jstring filename,
jshort ref)
...
JNIEXPORT jboolean JNICALL Java_hdf_h4_HDFDeprecated_DFSDwriteslab
( JNIEnv *env,
jclass clss,
jintArray  start,  /* IN: int[] */
jintArray stride,  /* IN: int[] */
