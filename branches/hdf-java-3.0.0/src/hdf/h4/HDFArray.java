...
public byte[] byteify() throws HDFException{
    ...
    if (ArrayDescriptor.dims == 1) {
        ...
        if (ArrayDescriptor.NT == 'B') {
            ...
            if (ArrayDescriptor.NT == 'I') {
                therow = hdf.h4.HDFNativeData.intToByte(0,ArrayDescriptor.dimlen[1],(int [])_theArray);
            } else if (ArrayDescriptor.NT == 'S') {
                therow = hdf.h4.HDFNativeData.shortToByte(0,ArrayDescriptor.dimlen[1],(short [])_theArray);
            } else if (ArrayDescriptor.NT == 'F') {
                therow = hdf.h4.HDFNativeData.floatToByte(0,ArrayDescriptor.dimlen[1],(float [])_theArray);
            } else if (ArrayDescriptor.NT == 'J') {
                therow = hdf.h4.HDFNativeData.longToByte(0,ArrayDescriptor.dimlen[1],(long [])_theArray);
            } else if (ArrayDescriptor.NT == 'D') {
                therow = hdf.h4.HDFNativeData.doubleToByte(0,ArrayDescriptor.dimlen[1],(double [])_theArray);
    ...
    while ( n < ArrayDescriptor.totalSize ) {
        ...
        if (ArrayDescriptor.NT == 'J') {
            arow = hdf.h4.HDFNativeData.longToByte(0,ArrayDescriptor.dimlen[ArrayDescriptor.dims],(long [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1]);
            arow = hdf.h4.HDFNativeData.longToByte(0,ArrayDescriptor.dimlen[ArrayDescriptor.dims],(long [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1]);
        } else if (ArrayDescriptor.NT == 'I') {
            arow = hdf.h4.HDFNativeData.intToByte(0,ArrayDescriptor.dimlen[ArrayDescriptor.dims],(int [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1]);
        } else if (ArrayDescriptor.NT == 'S') {
            arow = hdf.h4.HDFNativeData.shortToByte(0,ArrayDescriptor.dimlen[ArrayDescriptor.dims],(short [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1]);
        } else if (ArrayDescriptor.NT == 'B') {
            arow = (byte [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1];
        } else if (ArrayDescriptor.NT == 'F') {
            /* 32 bit float */
            arow = hdf.h4.HDFNativeData.floatToByte(0,ArrayDescriptor.dimlen[ArrayDescriptor.dims],(float [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1]);
        } else if (ArrayDescriptor.NT == 'D') {
            /* 64 bit float */
            arow = hdf.h4.HDFNativeData.doubleToByte(0,ArrayDescriptor.dimlen[ArrayDescriptor.dims],(double [])ArrayDescriptor.objs[ArrayDescriptor.dims - 1]);
        } else if (ArrayDescriptor.NT == 'L') {
            if (ArrayDescriptor.className.equals("java.lang.Byte")) {
...
public Object arrayify(byte[] bytes) throws HDFException {
    ...
    if (ArrayDescriptor.dims == 1) {
        ...
        try {
        if (ArrayDescriptor.NT == 'I') {
            int [] x = (int [])hdf.h4.HDFNativeData.byteToInt(_barray);
            System.arraycopy(x,0,_theArray,0,ArrayDescriptor.dimlen[1]);
            return _theArray;
        } else if (ArrayDescriptor.NT == 'S') {
            short [] x = hdf.h4.HDFNativeData.byteToShort(_barray);
            System.arraycopy(x,0,_theArray,0,ArrayDescriptor.dimlen[1]);
            return _theArray;
        } else if (ArrayDescriptor.NT == 'F') {
            float x[] = hdf.h4.HDFNativeData.byteToFloat(_barray);
            System.arraycopy(x,0,_theArray,0,ArrayDescriptor.dimlen[1]);
            return _theArray;
        } else if (ArrayDescriptor.NT == 'J') {
            long x[] = hdf.h4.HDFNativeData.byteToLong(_barray);
            System.arraycopy(x,0,_theArray,0,ArrayDescriptor.dimlen[1]);
            return _theArray;
        } else if (ArrayDescriptor.NT == 'D') {
            double x[] = hdf.h4.HDFNativeData.byteToDouble(_barray);
            System.arraycopy(x,0,_theArray,0,ArrayDescriptor.dimlen[1]);
            return _theArray;
        } else if (ArrayDescriptor.NT == 'B') {
    ...
    while ( n < ArrayDescriptor.totalSize ) {
        ...
        try {
        if (ArrayDescriptor.NT == 'J') {
            long [] arow = hdf.h4.HDFNativeData.byteToLong(n,ArrayDescriptor.dimlen[ArrayDescriptor.dims],_barray);
            ...
            int [] arow = hdf.h4.HDFNativeData.byteToInt(n,ArrayDescriptor.dimlen[ArrayDescriptor.dims],_barray);
            java.lang.reflect.Array.set(ArrayDescriptor.objs[ArrayDescriptor.dims - 2] ,
                (ArrayDescriptor.currentindex[ArrayDescriptor.dims - 1]), (Object)arow);
            ...
            short [] arow = hdf.h4.HDFNativeData.byteToShort(n,ArrayDescriptor.dimlen[ArrayDescriptor.dims],_barray);
            java.lang.reflect.Array.set(ArrayDescriptor.objs[ArrayDescriptor.dims - 2] ,
                (ArrayDescriptor.currentindex[ArrayDescriptor.dims - 1]), (Object)arow);
            ...
            float arow[] = hdf.h4.HDFNativeData.byteToFloat(n,ArrayDescriptor.dimlen[ArrayDescriptor.dims],_barray);
            java.lang.reflect.Array.set(ArrayDescriptor.objs[ArrayDescriptor.dims - 2] ,
                (ArrayDescriptor.currentindex[ArrayDescriptor.dims - 1]), (Object)arow);
            ...
            double [] arow = hdf.h4.HDFNativeData.byteToDouble(n,ArrayDescriptor.dimlen[ArrayDescriptor.dims],_barray);
            java.lang.reflect.Array.set(ArrayDescriptor.objs[ArrayDescriptor.dims - 2] ,
                (ArrayDescriptor.currentindex[ArrayDescriptor.dims - 1]), (Object)arow);
