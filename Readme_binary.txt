...
A Java 2 Virtual Machine, such as JDK1.3.1, or JRE1.3.1 is required. If you don't 
have a Java 2 VM, you must download and install one.
 
Download Java 2 Platform at:

http://java.sun.com/j2se for Windows, Solaris, and Linux
or
http://www.sgi.com/developers/devtools/languages/java.html for SGI
...
For Windows
    ...
    docs/
         UsersGuide     - The HDFView User's Guide
    lib/
