...
import hdf.h5.enums.H5S.H5S_class_t;
import hdf.h5.enums.H5S.H5S_sel_type;
import hdf.h5.enums.H5S.H5S_seloper_t;
...
public class H5S {
   ...
   **/
  public synchronized static native int H5Screate(H5S_class_t type)
   ...
   **/
  public synchronized static native void H5Sselect_hyperslab(int space_id, H5S_seloper_t op,
      long start[], long _stride[], long count[], long _block[])
  throws HDF5LibraryException, NullPointerException, IllegalArgumentException;
  /* #define NEW_HYPERSLAB_API */
//  #ifdef NEW_HYPERSLAB_API
//  public synchronized static native int H5Scombine_hyperslab(int space_id, H5S_seloper_t op,
//             const long start[], const long _stride[],
//             const long count[], const long _block[])
//  throws HDF5LibraryException, NullPointerException;
//  public synchronized static native int H5Sselect_select(int space1_id, H5S_seloper_t op,
//                                    int space2_id)
//  throws HDF5LibraryException, NullPointerException;
//  public synchronized static native int H5Scombine_select(int space1_id, H5S_seloper_t op,
//                                    int space2_id)
//  throws HDF5LibraryException, NullPointerException;
//  #endif /* NEW_HYPERSLAB_API */
   ...
   *  @exception HDF5LibraryException - Error from the HDF-5 Library.
   **/
  public synchronized static native void H5Sselect_elements(int space_id, H5S_seloper_t op,
   ...
   *  @exception HDF5LibraryException - Error from the HDF-5 Library.
   **/
  public synchronized static native H5S_class_t H5Sget_simple_extent_type(int space_id)
  throws HDF5LibraryException;
   ...
   *  @exception HDF5LibraryException - Error from the HDF-5 Library.
   **/
  public synchronized static native H5S_sel_type H5Sget_select_type(int spaceid)
  throws HDF5LibraryException, NullPointerException;
}
