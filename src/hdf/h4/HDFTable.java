...
void getfield( Class theType, Object obj, byte[] barray, int offset ) throws HDFException {
    ...
    byte arow[];
    if (type.equals("int")) {
        arow = hdf.h4.HDFNativeData.intToByte((Integer)obj);
        ...
        arow = hdf.h4.HDFNativeData.shortToByte((Short)obj);
        System.arraycopy(arow,0,barray,offset,2);
        return ;
    } else  if (type.equals("float")) {
        /* 32 bit float */
        arow = hdf.h4.HDFNativeData.floatToByte((Float)obj);
        System.arraycopy(arow,0,barray,offset,4);
        return ;
    } else  if (type.equals("long")) {
        arow = hdf.h4.HDFNativeData.longToByte((Long)obj);
        System.arraycopy(arow,0,barray,offset,8);
        return ;
    } else  if (type.equals("double")) {
        arow = hdf.h4.HDFNativeData.doubleToByte((Double)obj);
        System.arraycopy(arow,0,barray,offset,8);
        return ;
...
Object setfield( String type, Object obj, byte[] barray, int offset, int maxlen ) throws HDFException {
    ...
    if (type.equals("int")) {
        int[] f = hdf.h4.HDFNativeData.byteToInt(offset,1,barray);
        ...
        short[] f = hdf.h4.HDFNativeData.byteToShort(offset,1,barray);
        return new Short(f[0]) ;
    } else  if (type.equals("float")) {
         /* 32 bit float */
        float[] f = hdf.h4.HDFNativeData.byteToFloat(offset,1,barray);
        return new Float(f[0]) ;
    } else  if (type.equals("long")) {
        long[] f = hdf.h4.HDFNativeData.byteToLong(offset,1,barray);
        return new Long(f[0]) ;
    } else  if (type.equals("double")) {
        double[] f = hdf.h4.HDFNativeData.byteToDouble(offset,1,barray);
