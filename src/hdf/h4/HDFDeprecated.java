...
public class HDFDeprecated extends HDFLibrary {
    ...
    public final static String HDFPATH_PROPERTY_KEY = "hdf.h4.HDFLibrary.hdflib";
    static
    {
    ...
    public boolean  DFSDsetrange( Object max, Object min) throws HDFException {
        ...
        if (mncn.equals("java.lang.Integer")) {
            ...
            d1 = hdf.h4.HDFNativeData.intToByte(fmx.intValue());
            d2 = hdf.h4.HDFNativeData.intToByte(fmn.intValue());
        } else if (mncn.equals("java.lang.Float")) {
            Float fmx = (Float)max;
            Float fmn = (Float)min;
            d1 = hdf.h4.HDFNativeData.floatToByte(fmx.floatValue());
            d2 = hdf.h4.HDFNativeData.floatToByte(fmn.floatValue());
        } else if (mncn.equals("java.lang.Double")) {
            Double fmx = (Double)max;
            Double fmn = (Double)min;
            d1 = hdf.h4.HDFNativeData.doubleToByte(fmx.doubleValue());
            d2 = hdf.h4.HDFNativeData.doubleToByte(fmn.doubleValue());
        } else if (mncn.equals("java.lang.Short")) {
            Short fmx = (Short)max;
            Short fmn = (Short)min;
            d1 = hdf.h4.HDFNativeData.shortToByte(fmx.shortValue());
            d2 = hdf.h4.HDFNativeData.shortToByte(fmn.shortValue());
        } else if (mncn.equals("java.lang.Byte")) {
            Byte fmx = (Byte)max;
            Byte fmn = (Byte)min;
            d1 = hdf.h4.HDFNativeData.byteToByte(fmx.byteValue());
            d2 = hdf.h4.HDFNativeData.byteToByte(fmn.byteValue());
        } else {
